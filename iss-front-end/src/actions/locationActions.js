...
export const getLocation = (id) => {
    ...
    const promise = axios.get(`https://ill-serve-soup2-db.herokuapp.com/api/locations/${id}`)
    return dispatch=>{
...
export const changeLoc = (location, locationId) => {
    const promise = axios.put(`https://ill-serve-soup2-db.herokuapp.com/api/locations/${locationId}`, location)
    return dispatch=>{
...
export const deleteLoc = (id) => {
    const promise = axios.delete(`https://ill-serve-soup2-db.herokuapp.com/api/locations/${id}`)
    return dispatch =>{
